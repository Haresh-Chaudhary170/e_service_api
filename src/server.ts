...
const allowedOrigins = [FRONTEND, CLIENT, 'http://localhost:3000', 'http://192.168.18.95:3000', 'http://192.168.18.98:3000', 'https://your-production-domain.com', 'http://localhost:8000'];
