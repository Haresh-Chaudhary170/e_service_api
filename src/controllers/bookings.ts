...
class BookingController {
    ...
    // get booking of logged in customer
    @Route("get", "/customer", checkRole(['CUSTOMER']))
    async getBookingLoggedIn(req: Request, res: Response, next: NextFunction) {
    ...
    @Route("put", "/change/:id", checkRole(['SERVICE_PROVIDER']))
    ...
    @Route("get", "/get/:id", checkRole(['CUSTOMER', 'SERVICE_PROVIDER', 'ADMIN']))
    ...
    async createBooking(req: Request, res: Response, next: NextFunction) {
        ...
        try {
            let booking;
            if (type === "HOME") {
                const totalAmountT = totalAmount + provider.VisitCharges;
                // Create the booking
                booking = await prisma.booking.create({
                    data: {
                        ...
                        scheduleStartTime,
                        scheduleEndTime,
                        totalAmount: parseFloat(totalAmountT),
                        notes,
                    },
                });
            } else {
            ...
            if (userGoogleCredentials) {
                if (userGoogleCredentials.googleAccessToken) {
                    await createGoogleCalendarEvent(
                        ...
                        'Asia/Kathmandu' // Adjust the timezone as needed
                    );
                }
